...
def index():
    ...
    if form.validate_on_submit():
        ...
        return render_template('index.html', title = 'STYL - Recommendations based on that one Song That You Love', \
                form = form, html_code = html_code)

    return render_template('index.html', title = 'STYL - Recommendations based on that one Song That You Love', form = form)
